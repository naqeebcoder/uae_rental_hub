            ...
            <div className="container relative z-10">
                <div className="lets-talk__inner text-center py-20">
                    <div className="lets-talk__title mb-8">
                        <p className="text-white text-lg mb-2" style={{ textAlign: "left" }}>Rent Your Vehical</p>
                        <h2 className="text-4xl font-bold text-black">Interested in Renting?</h2>
                    </div>

                    <div className="lets-talk__btn-boxes flex justify-center gap-6 mt-8">
                        {/* <div className="lets-talk__btn-1">
                            <a href="/contact" className="thm-btn inline-flex items-center gap-2">
                                Contact Us <FaArrowRight />
                            </a>
                        </div> */}
                        <div className="lets-talk__btn-2">
                            <a href="/car-list-v-1" className="thm-btn inline-flex items-center gap-2 mt-4">
